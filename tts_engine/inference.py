...
AVAILABLE_VOICES = ["jana", "thomas", "max", "tara", "leah", "jess", "leo", "dan", "mia", "zac", "zoe"]
...
def generate_tokens_from_api(prompt: str, voice: str = DEFAULT_VOICE, temperature: float = TEMPERATURE, 
                           ...
                           repetition_penalty: float = REPETITION_PENALTY, speed: float = 1.0) -> Generator[str, None, None]:
    ...
    payload = {
        "model": "Orpheus-3b-German-FT-Q8_0.gguf",
    ...
    print("Vor dem Payload-Print")
    print(f"Payload uses model: {payload['model']}")
    print("Nach dem Payload-Print")
...
def generate_speech_from_api(prompt, voice=DEFAULT_VOICE, output_file=None, temperature=TEMPERATURE, 
                     top_p=TOP_P, max_tokens=MAX_TOKENS, repetition_penalty=REPETITION_PENALTY, speed=1.0):
...
if __name__ == "__main__":
    ...
    load_dotenv()
    API_KEY = os.getenv("COMPUT3_API_KEY")
    main()
